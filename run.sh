...
if [ $1 == 3 ]
then
scrun -group=machinefile2,network=sctp -nodes=4x2 ./mpi.exe -f tsp_data/eil51.tsp -b -m -t 60
fi
if [ $1 == 4 ]
then
...
if [ $1 == 6 ]
then
scrun -group=pcc,network=sctp -nodes=8x2 ./mpi.exe -f tsp_data/lin318.tsp -b -m -t 300
fi
