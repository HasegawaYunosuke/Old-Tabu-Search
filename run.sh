...
if [ $1 == 1 ]
then
scrun -group=machinefile,network=sctp -nodes=4x2 ./nompi.exe -f tsp_data/pr1002.tsp  -l -t 1800
fi
if [ $1 == 2 ]
then
scrun -group=machinefile2,network=sctp -nodes=4x2 ./nompi.exe -f tsp_data/rat575.tsp  -l -t 1800
fi
if [ $1 == 3 ]
then
scrun -group=machinefile2,network=sctp -nodes=4x2 ./mpi.exe -f tsp_data/rat575.tsp -b -m -t 120
fi
if [ $1 == 4 ]
then
...
scrun -group=pcc,network=sctp -nodes=8x2 ./mpi.exe -f tsp_data/rat575.tsp -b -m -t 120
fi
