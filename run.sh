...
if [ $1 == 1 ]
then
scrun -group=machinefile2,network=sctp -nodes=4x2 ./mpi.exe -f tsp_data/lin318.tsp  -l -m -t 10 -p
fi
if [ $1 == 2 ]
then
scrun -group=machinefile2,network=sctp -nodes=4x2 ./nompi.exe -f tsp_data/lin318.tsp  -l -t 1800
fi
if [ $1 == 3 ]
then
...
if [ $1 == 6 ]
then
scrun -group=machinefile,network=sctp -nodes=4x2 ./mpi.exe -f tsp_data/rat575.tsp -b -m -t 1800
fi
